...
const Simulator = () => {
  ...
  return (
    <div className="p-4 bg-gray-900 flex justify-center items-center min-h-screen">
      ...
      {/* Maze Section */}
      <div className="grid grid-cols-5 grid-rows-8 gap-2 mr-1 rounded-lg shadow-lg w-[600px] h-[500px] max-w-4xl">
      ...
      <div className="grid grid-cols-11 grid-rows-8 gap-2 bg-red-800 p-4 rounded-lg shadow-lg w-[700px] h-[500px] max-w-4xl">
        ...
        {/* Config Section */}
        <div className="col-start-6 col-span-6 flex flex-col gap-4">
